...
import (
	...
	"log"
	"net"
	"net/http" // import net/http package to serve wiki pages.
	"regexp"
)
...
func (p *Page) save() error {
	...
	// if all goes well, ioutil.WriteFile returns nil.
	return ioutil.WriteFile(filename, p.Body, 0600)
}

// loadPage with error handling
...
func renderTemplate(w http.ResponseWriter, tmpl string, p *Page) {
	...
	if err != nil {
		// change error syntax since go 1.0
		// os.Error.String() to error.Error()
